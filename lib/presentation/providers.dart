...
import 'package:diet_fairy/domain/usecase/delete_feed_use_case.dart';
...
final deleteFeedUsecaseProvider = Provider<DeleteFeedUseCase>(
  (ref) {
    final feedRepo = ref.read(_feedRespositoryProvider);
    return DeleteFeedUseCase(feedRepo);
  },
);
